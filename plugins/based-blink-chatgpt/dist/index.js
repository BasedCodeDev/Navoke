...
function createWorkflows(sdk) {
    ...
    function canResumeFailedChatGptPromptImageRun(run) {
        if (run.status !== "failed" || run.workflowId !== "based-blink.chatgpt.extension-image-prompt")
            return false;
    ...
    function canResumeFailedChatGptImagePromptRun(run) {
        if (run.status !== "failed" || run.workflowId !== "based-blink.chatgpt.extension-image-prompt-transform")
            return false;
